...
export const PinContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative group/pin cursor-pointer w-full",
        containerClassName
      )}
...
export const PinPerspective = ({
  ...
  return (
    <motion.div className="pointer-events-none absolute inset-0 flex items-start justify-center opacity-0 group-hover/pin:opacity-100 z-40 transition duration-500">
      <div className="absolute top-0 left-1/2 -translate-x-1/2" style={{ marginTop: '-1.5rem' }}>
        <a
          href={href}
          target={"_blank"}
